...
interface USNutritionLabelProps {
...
/**
 * The FDA nutrition facts panel: calories per serving, rated against daily values.
 *
 * Reached through `NutritionLabel`, which picks a labelling convention.
 */
export default function USNutritionLabel({
  nutritionInfo,
  servingSize,
  prep,
}: USNutritionLabelProps) {
