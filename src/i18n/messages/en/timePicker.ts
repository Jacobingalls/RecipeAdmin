/** The time picker used when logging an entry. */
export const enTimePicker = {
  'timePicker.block.lateNight': 'Late night',
  'timePicker.block.morning': 'Morning',
  'timePicker.block.midday': 'Midday',
  'timePicker.block.afternoon': 'Afternoon',
  'timePicker.block.evening': 'Evening',
  'timePicker.block.night': 'Night',
  ...
  'timePicker.customTitle': 'Custom',
  'timePicker.customLabel': 'Pick a specific date and time',
