...
export const enAuth = {
  ...
  'credentials.deleteMessage': 'This will permanently delete {name}. This action cannot be undone.',
  'credentials.revokeMessage': 'This will permanently revoke {name}. This action cannot be undone.',
